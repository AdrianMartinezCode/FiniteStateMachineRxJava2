...
public class PeacefulVillage extends Village {


    private static final int MAX_MIXED_FAMILIES = 5;
    private static final int MIN_MIXED_FAMILIES = 2;

    private static final int MAX_WARRIOR_FAMILIES = 3;
    private static final int MIN_WARRIOR_FAMILIES = 1;

    private static final int MAX_PEACEFUL_FAMILIES = 10;
    private static final int MIN_PEACEFUL_FAMILIES = 5;


    @Inject
    public PeacefulVillage(Supplier<MixedFamily> mixedFamilySupplier,
